...
uint8_t gaiaReadSourceSettings(
	...
	//
	//
	char  s_x_parameter_type[128] = { 0 };//str1024
	char  s_y_parameter_type[128] = { 0 };//str1024
	char  s_z_parameter_type[128] = { 0 };//str1024

	smdAccessVarByName(p_handle, "x_parameter_type", NULL, s_x_parameter_type);
	smdAccessVarByName(p_handle, "y_parameter_type", NULL, s_y_parameter_type);
	smdAccessVarByName(p_handle, "z_parameter_type", NULL, s_z_parameter_type);
	...
	//
	//
	smdAccessVarByName(p_handle, "color_filter", NULL, s_color_filter);

	     if (strcmp(s_color_filter, "RANDOM_COLOR_SEED")    == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_RANDOM_COLOR_SEED;    p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_RANDOM_COLOR_SEED;    }
	else if (strcmp(s_color_filter, "BARYCENTRIC_DISTANCE") == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_BARYCENTRIC_DISTANCE; p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_BARYCENTRIC_DISTANCE; }
	else if (strcmp(s_color_filter, "TEFF")                 == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_TEFF;                 p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_TEFF;                 }
	else if (strcmp(s_color_filter, "LOGG")                 == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_LOGG;                 p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_LOGG;                 }
	else if (strcmp(s_color_filter, "FEH")                  == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_FEH;                  p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_FEH;                  }
	else if (strcmp(s_color_filter, "ALPHAFE")              == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_ALPHAFE;              p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_ALPHAFE;              }
	else if (strcmp(s_color_filter, "AGE")                  == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_AGE;                  p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_AGE;                  }
	else if (strcmp(s_color_filter, "MASS")                 == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_MASS;                 p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_MASS;                 }
	else if (strcmp(s_color_filter, "RADIUS")               == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_RADIUS;               p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_RADIUS;               }
	else if (strcmp(s_color_filter, "VSINI")                == 0) { p_model->color_filter_flags = GAIA_MODEL_COLOR_FILTER_FLAGS_VSINI;                p_model->color_filter_type = GAIA_MODEL_COLOR_FILTER_TYPE_VSINI;                }
...
uint8_t gaiaReadGraphicsSettings(
	...
	char           s_shade_type[128] = { 0 };//str1024
	char           s_view_mode [128] = { 0 };//str1024
	char           s_view_point[128] = { 0 };//str1024
	...
	//
	//
	smdAccessVarByName(p_handle, "view_mode", NULL, s_view_mode);

	     if (strcmp(s_view_mode, "CARTESIAN") == 0) { p_model->view_mode = GAIA_VIEW_MODE_CARTESIAN; }
	else if (strcmp(s_view_mode, "POLAR")     == 0) { p_model->view_mode = GAIA_VIEW_MODE_POLAR;     }
	...
	//
	//
	smdAccessVarByName(p_handle, "shade_type", NULL, s_shade_type);

	     if (strcmp(s_shade_type, "PIXEL")    == 0)  { p_model->shade_type = GAIA_MODEL_SHADE_TYPE_PIXEL;           }
	else if (strcmp(s_shade_type, "CIRCLE")   == 0)  { p_model->shade_type = GAIA_MODEL_SHADE_TYPE_CIRCLE;          }
	else if (strcmp(s_shade_type, "CLOUD")    == 0)  { p_model->shade_type = GAIA_MODEL_SHADE_TYPE_CLOUD;           }
	else if (strcmp(s_shade_type, "ANIMATED") == 0)  { p_model->shade_type = GAIA_MODEL_SHADE_TYPE_ANIMATED_CLOUD;  }
...
uint8_t gaiaWriteInterface(
	...
	smdWriteLine(p_handle, 1, "camera_right_ascension___rad", SMD_VAR_TYPE_FLOAT32, &p_transform->rotation[0]);
	smdWriteLine(p_handle, 1, "camera_declination_______rad", SMD_VAR_TYPE_FLOAT32, &p_transform->rotation[1]);
